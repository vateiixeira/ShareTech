...
class Produto(models.Model):
    ...
    img1 =  models.CharField('img1', max_length=300, null=True)
    img2 =  models.CharField('img2', max_length=300, null=True)
    img3 =  models.CharField('img3', max_length=300, null=True)
    img4 =  models.CharField('img4', max_length=300, null=True)
